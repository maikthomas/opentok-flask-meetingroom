...
const options = {
  credentials: {
  apiKey: document.getElementById('app-main').dataset.apiKey,
  sessionId: document.getElementById('app-main').dataset.sessionId,
  token: document.getElementById('app-main').dataset.token,
},
